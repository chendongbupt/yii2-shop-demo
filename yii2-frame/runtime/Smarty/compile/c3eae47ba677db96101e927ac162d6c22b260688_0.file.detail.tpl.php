<?php
/* Smarty version 3.1.29, created on 2016-04-11 13:31:28
  from "E:\Demo\yii2-frame\views\backend\shop-manaer\detail.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_570b36b0761842_88976956',
  'file_dependency' => 
  array (
...
function content_570b36b0761842_88976956 ($_smarty_tpl) {
?>
<aside>
    <a href="/backend/shop-manaer/shop">返回列表</a>
</aside>
...
" alt="" width="200" height="200"/>
    ...
    操作： <?php if ($_smarty_tpl->tpl_vars['shop']->value['is_check'] != -1) {?><a href="###" data-act="/backend/shop-manaer/check/-1/<?php echo $_smarty_tpl->tpl_vars['shop']->value['shop_id'];?>
">审核不通过</a><?php }?>
    <?php if ($_smarty_tpl->tpl_vars['shop']->value['is_check'] != 1) {?><a href="###" data-act="/backend/shop-manaer/check/1/<?php echo $_smarty_tpl->tpl_vars['shop']->value['shop_id'];?>
">审核通过</a><?php }?>
    <br/>
...
" alt="" width="200" height="200"/><?php } else { ?>未提交<?php }?>
    ...
    操作： <?php if ($_smarty_tpl->tpl_vars['shop']->value['is_auth'] != -1) {?><a href="###" data-act="/backend/shop-manaer/auth/-1/<?php echo $_smarty_tpl->tpl_vars['shop']->value['shop_id'];?>
">认证不通过</a><?php }?>
    <?php if ($_smarty_tpl->tpl_vars['shop']->value['is_auth'] != 1) {?><a href="###" data-act="/backend/shop-manaer/auth/1/<?php echo $_smarty_tpl->tpl_vars['shop']->value['shop_id'];?>
">认证通过</a><?php }?>
